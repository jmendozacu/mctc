...
add_action( 'google-map', 'add_frontend_scripts' );
// Set it up gangsta!
...
function add_frontend_scripts() {
    ...
    wp_enqueue_script(
        'map-js',
        plugin_dir_oath( __FILE__.'/js/map.js' )
    );
}
...
// Creates WP Destinations administration page.
function wp_destinations_admin_page() {
    $page_title = 'WP Destinations';
    $menu_title = 'WP Destinations';
    $capability = '';
    $menu_slug = 'wp-destinations';
    $function = 'wp_destinations_admin_display';
    $icon_url = ' ';
    $position = 24;
