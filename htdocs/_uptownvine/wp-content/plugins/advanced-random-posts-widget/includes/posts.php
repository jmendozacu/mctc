					...
					$html .= '<li class="arpw-li arpw-clearfix">';
						...
						if ( $args['thumbnail'] ) :
							...
							if ( has_post_thumbnail() ) :
								...
								$html .= '<a class="inactive-link" href="#" rel="bookmark">';
						...
						$html .= '<div class="arpw-text-container"><div class="text-wrap"><h3><a class="arpw-title" href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . esc_attr( get_the_title() ) . '</a></h3>';
						...
						if ( $args['excerpt'] ) :
							$html .= '<div class="arpw-summary">' . wp_trim_words( apply_filters( 'arpw_excerpt', get_the_excerpt() ), $args['excerpt_length'], ' &hellip;' ) . '<br><br><p><a class="read-more" href="' . esc_url( get_permalink( get_page_by_title() ) ) . '">Read More</a></p></div><!-- arwp Container --></div><!-- Text Wrap --></div>';
						endif;
