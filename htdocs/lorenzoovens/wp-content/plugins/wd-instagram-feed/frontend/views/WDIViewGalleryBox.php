      ...
      function wdi_comment() {
        ...
        if (jQuery(".wdi_comment_container").hasClass("wdi_open")) {
          ...
          if (!border_width) {
            ...
            jQuery(".wdi_comment_container").animate({<?php echo $theme_row->lightbox_comment_pos; ?>:
            -jQuery(".wdi_comment_container").width() - border_width
        },
            500
        )
          ...
          jQuery(".wdi_popup_embed").animate({
            ...
            jQuery(".wdi_filmstrip_container").animate({<?php echo $width_or_height; ?>:
            jQuery(".wdi_spider_popup_wrap").<?php echo $width_or_height; ?>()
        },
            500
        )
            jQuery(".wdi_filmstrip").animate({<?php echo $width_or_height; ?>:
            jQuery(".wdi_spider_popup_wrap").<?php echo $width_or_height; ?>() - 40
        },
            500
        )
            /* Set filmstrip initial position.*/
          ...
          if (comment_container_width > jQuery(window).width()) {
            ...
            <?php echo $theme_row->lightbox_comment_pos; ?>: jQuery(".wdi_comment_container").width(),
                width
        :
            jQuery("#wdi_spider_popup_wrap").width() - jQuery(".wdi_comment_container").width()
        },
            500
        )
            jQuery(".wdi_image_container").animate({
          ...
          jQuery(".wdi_popup_embed").animate({
            ...
            jQuery(".wdi_filmstrip_container").css({<?php echo $width_or_height; ?>:
            jQuery("#wdi_spider_popup_wrap").<?php echo $width_or_height; ?>() -; <?php echo($filmstrip_direction == 'vertical' ? 0 : 'jQuery(".wdi_comment_container").width()'); ?>})
            jQuery(".wdi_filmstrip").animate({<?php echo $width_or_height; ?>:
            jQuery(".wdi_filmstrip_container").<?php echo $width_or_height; ?>() - 40
        },
            500
        )
            /* Set filmstrip initial position.*/
      ...
      jQuery(document).ready(function () {
        ...
        jQuery(".wdi_filmstrip_right").on(wdi_click, function () {
          ...
          if (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> >= -(jQuery(".wdi_filmstrip_thumbnails").<?php echo $width_or_height; ?>() - jQuery(".wdi_filmstrip").<?php echo $width_or_height; ?>())) {
            ...
            if (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> < -(jQuery(".wdi_filmstrip_thumbnails").<?php echo $width_or_height; ?>() - jQuery(".wdi_filmstrip").<?php echo $width_or_height; ?>() - <?php echo $filmstrip_thumb_margin_hor + $image_filmstrip_width; ?>)) {
                jQuery(".wdi_filmstrip_thumbnails").animate({<?php echo $left_or_top; ?>:
                ...
                jQuery(".wdi_filmstrip_thumbnails").animate({<?php echo $left_or_top; ?>:
                (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> - <?php echo $filmstrip_thumb_margin_hor + $image_filmstrip_width; ?>)
            },
                500, 'linear'
            )
            };;
        ...
        jQuery(".wdi_filmstrip_left").on(wdi_click, function () {
          ...
          if (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> < 0) {
            ...
            if (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> > - <?php echo $filmstrip_thumb_margin_hor + $image_filmstrip_width; ?>) {
                ...
                jQuery(".wdi_filmstrip_thumbnails").animate({<?php echo $left_or_top; ?>:
                (jQuery(".wdi_filmstrip_thumbnails").position().<?php echo $left_or_top; ?> + <?php echo $image_filmstrip_width + $filmstrip_thumb_margin_hor; ?>)
            },
                500, 'linear'
            )
            };;
        ...
        jQuery(".wdi_toggle_container").on(wdi_click, function () {
          ...
          if (jQuery(".wdi_toggle_container i").hasClass(wdi_open_toggle_btn_class)) {
            ...
            ?>
              jQuery(".wdi_ctrl_btn_container").animate({<?php echo $theme_row->lightbox_ctrl_btn_pos; ?>:
              '-' + jQuery(".wdi_ctrl_btn_container").height()
          },
              500
          )
        ...
        jQuery(".wdi_resize-full").on(wdi_click, function () {
          ...
          if (jQuery(".wdi_resize-full").hasClass("fa-compress")) {
            ...
            jQuery(".wdi_popup_embed").animate({
              ...
              jQuery(".wdi_filmstrip_container").animate({<?php echo $width_or_height; ?>:
              wdi_popup_current_<?php echo $width_or_height; ?> -; <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?>},
              500
          )
              jQuery(".wdi_filmstrip").animate({<?php echo $width_or_height; ?>:
              wdi_popup_current_<?php echo $width_or_height; ?> - <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?> -40
          },
              500
          )
              /* Set filmstrip initial position.*/
            ...
            jQuery(".wdi_popup_embed").animate({
              ...
              jQuery(".wdi_filmstrip_container").animate({<?php echo $width_or_height; ?>:
              jQuery(window).<?php echo $width_or_height; ?>() -; <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?>},
              500
          )
              jQuery(".wdi_filmstrip").animate({<?php echo $width_or_height; ?>:
              jQuery(window).<?php echo $width_or_height; ?>() - <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?> -40
          },
              500
          )
              /* Set filmstrip initial position.*/
          ...
          function wdi_exit_fullscreen() {
            ...
            jQuery("#wdi_spider_popup_wrap").on("fscreenclose", function() {
              ...
              wdi_change_watermark_container();
                jQuery(".wdi_filmstrip_container").css({<?php echo $width_or_height; ?>:
                wdi_popup_current_<?php echo $width_or_height; ?> -; <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?>})
                jQuery(".wdi_filmstrip").css({<?php echo $width_or_height; ?>:
                wdi_popup_current_<?php echo $width_or_height; ?> - <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?>-40
            })
                /* Set filmstrip initial position.*/
              wdi_set_filmstrip_pos(wdi_popup_current_<?php echo $width_or_height; ?> - 40);
            ...
            if (jQuery.isFunction(jQuery().fullscreen)) {
              if (jQuery.fullscreen.isFullScreen()) {
                ...
                if (jQuery.fullscreen.isFullScreen()) {*/
                  ...
                  wdi_change_watermark_container();
                  jQuery(".wdi_filmstrip_container").css({<?php echo $width_or_height; ?>:
                  (screen_<?php echo $width_or_height; ?> - <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?>)
              })
                  jQuery(".wdi_filmstrip").css({<?php echo $width_or_height; ?>:
                  (screen_<?php echo $width_or_height; ?> - <?php echo($filmstrip_direction == 'horizontal' ? 'comment_container_width' : 0); ?> -40)
              })
                  /* Set filmstrip initial position.*/
