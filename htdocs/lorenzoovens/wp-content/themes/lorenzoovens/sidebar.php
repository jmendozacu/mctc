	...
	<aside id="secondary" class="widget-area col s12 m4 l4" role="complementary">
        <?php while ( have_posts()) : the_post();  ?>
					...
					<div class="card">
                        ...
                        <a href="<?php the_permalink( $id ); ?>"><img src="<?php echo the_field('profile_image', 'user_2'); ?>" alt="Lorenzo's Profile Image"></a>
                        <p><?php echo the_field('profile_short_description', 'user_2'); ?></p>
                        <a href="<?php the_permalink( $id ); ?>" class="waves-effect waves-light red darken-4 btn profile-btn">Read More</a>
                    </div><!-- .card -->
				<?php
			endwhile; // WordPress Post Loop
