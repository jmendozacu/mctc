...
if ( ! class_exists( 'Customizer_Library' ) ) :
	...
	// Arbitrary content control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/heading-controls.php';

	// Upgrade Premium control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/upgrade-control.php';

	// Radio Image control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/radio-image.php';

	// Range control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/range-slider.php';

	// Multi-Checkbox control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/control-checkbox-multiple.php';

	// Typography Select control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/type-selects.php';

	// Google Fonts control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/google-fonts-control.php';

	// Google Font Dropdown control
	require plugin_dir_path( __FILE__ ) . 'custom-controls/advanced-dropdown.php';
	...
	class Customizer_Library {
		...
		public static function register( $wp_customize ) {
			...
			Structr_Customize_Typography::register( $wp_customize );
		}
